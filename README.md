...
-d
\"{\\\"deadline\\\":\\\"2019-09-19T16:42:40.396Z\\\",\\\"intendedVehicle\\\":\\\"Ve0001\\\",

\\\"destinations\\\":\[{\\\"locationName\\\":\\\"GiN01\\\",\\\"operation\\\":\\\"Load
cargo\\\"}\]}\"
...
-d
\"{\\\"deadline\\\":\\\"2019-09-19T16:42:40.396Z\\\",\\\"intendedVehicle\\\":\\\"Ve0002\\\",

\\\"destinations\\\":\[{\\\"locationName\\\":\\\"GiN02\\\",\\\"operation\\\":\\\"Load
cargo\\\"}\]}\"
...
-d
\"{\\\"deadline\\\":\\\"2019-09-19T16:42:40.396Z\\\",\\\"intendedVehicle\\\":\\\"Ve0003\\\",

\\\"destinations\\\":\[{\\\"locationName\\\":\\\"GiS01\\\",\\\"operation\\\":\\\"Load
cargo\\\"}\]}\"
...
-d
\"{\\\"deadline\\\":\\\"2019-09-19T16:42:40.396Z\\\",\\\"intendedVehicle\\\":\\\"Ve0004\\\",
...
6-tn-demo-lb-1234-create-to-part1.sh, 类似;

4-tn-demo-lb-1234-create-to-nv-part1.sh, 类似但未预订车辆;

8-tn-demo-lb-1234-create-to-nv-part1.sh, 类似但未预订车辆.
...
\\\"destinations\\\":\[{\\\"locationName\\\":\\\"St01\\\",\\\"operation\\\":\\\"Unload
cargo\\\"},
...
\\\"destinations\\\":\[{\\\"locationName\\\":\\\"St02\\\",\\\"operation\\\":\\\"Unload
cargo\\\"},
...
9-tn-demo-lb-1234-create-to-part2.sh, 类似;

5-tn-demo-lb-1234-create-to-nv-part2.sh, 类似但未预订车辆;

7-tn-demo-lb-1234-create-to-nv-part2.sh, 类似但未预订车辆.
...
List\<DriveOrder> driveOrderList =
transportOrder.getFutureDriveOrders();
...
for (DriveOrder do\_: dos) {

List\<Route.Step> steps = do\_.getRoute().getSteps();
...
注:《改造OpenTCS之如何避免无效路由of基于OpenTCS的二次开发实践》

一文中提及的removeUnusablePoints, 已不再需要,
其逻辑应在该接口的实现中体现即可.
...
import static
org.opentcs.components.kernel.Router.PROPKEY_ROUTING_GROUP;
...
注：网友们提到的不能派单或不能自动分配车辆现象，可能因为前言所述两篇文章忽略了此部分而导致。
...
import static org.opentcs.strategies.basic.dispatching

.DefaultDispatcherConfiguration.RerouteTrigger.ROUTE_STEP_FINISHED;
